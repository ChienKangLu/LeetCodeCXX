...
REGISTER_TYPED_TEST_SUITE_P(KthLargestElementInAnArrayTestBase, 
                            test1,
                            test2,
                            test3);

INSTANTIATE_TYPED_TEST_SUITE_P(KthLargestElementInAnArrayTest, KthLargestElementInAnArrayTestBase, TestTypes, TypeNames);