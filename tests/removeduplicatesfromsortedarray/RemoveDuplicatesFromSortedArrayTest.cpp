...
REGISTER_TYPED_TEST_SUITE_P(RemoveDuplicatesFromSortedArrayTestBase, test1,
                            test2, test3, test4, test5, test6, test7);

INSTANTIATE_TYPED_TEST_SUITE_P(RemoveDuplicatesFromSortedArrayTest,
                               RemoveDuplicatesFromSortedArrayTestBase,
                               TestTypes, TypeNames);